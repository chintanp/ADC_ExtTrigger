...
// as part of Lab 11 implement this function
	...
	//iterate through the array buffer and output each element to transmit buffer by calling UART_OutChar() function. 
	while (buffer[i]!=0){
...
// as part of Lab 11 implement this function
	...
	// Convert the input number to **** if greater than 9999
	if(n > 9999) {
		sprintf(String, "**** \0");
	}
		...
		strcat(temp, " \0");
		sprintf(String, temp);	
		//strcpy(String, strcat(temp, " \0"));
	}
	else if (n <= 999 && n > 99) {
   	strcat(temp, " \0");
		//strcat(" ", temp);
		sprintf(String, " %s", temp);
		//strcpy(String, strcat(" ", temp));
	}
	else if (n <= 99 && n > 9) {
		strcat(temp, " \0");
		sprintf(String, "  %s", temp);
...
// as part of Lab 11 implement this function
	...
	if(n > 9999) {
		...
		sprintf(String, "%.3f cm\0", tempf);
		//strcpy(String, strcat((char)tempf, " cm\0"));
	}
}
